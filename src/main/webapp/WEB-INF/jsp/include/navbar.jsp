...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top"
	id="mainNav">
	<a class="navbar-brand" href="${root }/home">Training Management</a>
	...
	<div class="collapse navbar-collapse" id="navbarResponsive">
		<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
			<li class="nav-item" data-toggle="tooltip" data-placement="right"
				title="Dashboard"><a class="nav-link" href="${root }/home"> <i
					class="fa fa-fw fa-dashboard"></i> <span class="nav-link-text">Dashboard</span>
			</a></li>
			<!-- Tables option Disabled -->
			<!-- <li class="nav-item" data-toggle="tooltip" data-placement="right"
			...
			<li class="nav-item" data-toggle="tooltip" data-placement="right"
				...
				href="#collapseStudent" data-parent="#exampleAccordion"> <i
					class="fa fa-fw fa-graduation-cap"></i> <span class="nav-link-text">Student
						</span>
			</a>
				<ul class="sidenav-second-level collapse" id="collapseStudent">
					<li><a href="${root }/student/add">Add Student</a></li>
					<li><a href="${root }/student/list">Display Student</a></li>
				</ul></li>
			<li class="nav-item" data-toggle="tooltip" data-placement="right"
				title="Menu Levels"><a
				class="nav-link nav-link-collapse collapsed" data-toggle="collapse"
				href="#collapseCourse" data-parent="#exampleAccordion"> <i
					class="fa fa-fw fa-book"></i> <span class="nav-link-text">Course
						</span>
			</a>
				<ul class="sidenav-second-level collapse" id="collapseCourse">
					<li><a href="${root }/course/add">Add Course</a></li>
					<li><a href="${root }/course/list">Display Course</a></li>
				</ul></li>
			<li class="nav-item" data-toggle="tooltip" data-placement="right"
				title="Tables"><a class="nav-link" href="${root }/installment"> <i
					class="fa fa-fw fa-balance-scale"></i> <span class="nav-link-text">Installment</span>
			</a></li>
		</ul>
